...
const loadFile = (e) => {
    ...
    if(!file) return; //return if user hasn't select any file 
    previewImg.src = URL.createObjectURL(file); // passing selected file url to previsw img src
 ...
 const resizeAndDownload = () => {
     ...
     // setting canvas width and height according to the input values
     ...
     a.download = new Date().getTime(); // passing current time as file download value
